...
function showNextPageButton(){
	...
	document.getElementById("nextButton").style.color = "#5B3000";
	document.getElementById("nextButton").style.backgroundColor = "#fad687";
...
function hideNextPageButton(){
	...
	document.getElementById("nextButton").style.color = "#fad687";
	document.getElementById("nextButton").style.backgroundColor = "#fff4db";

}

function showPrevPageButton(){

	document.getElementById("prevButton").style.color = "#5B3000";
	document.getElementById("prevButton").style.backgroundColor = "#fad687";
	
}

function hidePrevPageButton(){

	document.getElementById("prevButton").style.backgroundColor = "#fff4db";
	document.getElementById("prevButton").style.color = "#fad687";
...
function editContact(ID, FirstName, LastName, Phone, Email){
    ...
    document.getElementById("editContactDiv").style.display = "grid";
...
function addContactButton(){
	document.getElementById("accessUIDiv").style.display = "none";
    document.getElementById("addContactDiv").style.display = "grid";
	document.getElementById("spacerDiv1").style.display = "none";
	document.getElementById("spacerDiv2").style.display = "block";
	...
	try
	{
		xhr.onreadystatechange = function() 
		{
			if (this.readyState == 4 && this.status == 200) 
			{
				...
				addResult.style.visibility = "visible";
	...
	try
	{
		xhr.onreadystatechange = function() 
		{
			if (this.readyState == 4 && this.status == 200) 
			{
				...
				deleteResult.style.visibility = "visible";

				// Hide it after 5 seconds
				setTimeout(() => {
					deleteResult.style.visibility = "hidden";
				}, 5000);
